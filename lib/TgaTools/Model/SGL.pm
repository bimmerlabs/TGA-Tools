...
sub rgb_palette ($color_map_entries, $path, $in_img, $config) {
    my $filename = "$path\\BG_DEF\\$in_img.h";
    open(my $out_fh, '>', $filename) or die "Can't open $filename: $!";
	    ...
	    print $out_fh "// this file is autogenerated - see tga_tools.pl\n\n";
	    ...
	    print $out_fh "jo_palette	*".lc($in_img)."_palette_handling(void)\n";
	    print $out_fh "{\n";
		...
		print $out_fh "    jo_set_tga_palette_handling(".lc($in_img)."_palette_handling);\n";
    ...
    open($out_fh, '>', $filename) or die "Can't open $filename: $!";
	    ...
	    print $out_fh "#define NORMAL_MAP_MODE $config->{image}{normal_map}\n\n";
    ...
    open($out_fh, '>', $filename) or die "Can't open $filename: $!";
	    ...
	    print $out_fh "#include \"BG_DEF/".uc($in_img).".h\"\n\n";
